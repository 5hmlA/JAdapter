 ...
 */
public abstract class AbsLoadMoreWrapperAdapter2<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements IVBrecvAdapter<T>
    ,OnViewClickListener {
  ...
  public final static String TAG = AbsLoadMoreWrapperAdapter2.class.getSimpleName();
  /**
  ...
  private AbsLoadMoreWrapperAdapter2.LoadMoreSpanSizeLookup mSpanSizeLookup;
   ...
   */
  @Keep
  public AbsLoadMoreWrapperAdapter2 setPagesize(int pagesize) {
...
//      getLoadMoreStateBean().tips = tips;
  ...
  @Keep
  public AbsLoadMoreWrapperAdapter2 setLoadeMoreWrapperStyle(int style) {
    mLoadMoreWrapperStyle = style;
    return this;
  }

  @Keep
  public AbsLoadMoreWrapperAdapter2 setOnMoreloadListener(OnMoreloadListener listener) {
    mListener = listener;
    return this;
  }
